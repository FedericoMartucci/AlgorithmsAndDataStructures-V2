...
{
    tNodoPila* nodoAInsertar = (tNodoPila*) malloc(sizeof(tNodoPila));
...
{
    tNodoPila* nodoAInsertar;

    if((nodoAInsertar = (tNodoPila*) malloc(sizeof(tNodoPila))) == NULL ||
